...
const Footer = () => {
  ...
  return (
    <footer className="">
  <div className="flex justify-evenly max-lg:flex-col max-lg:items-center max-lg:gap-12 bg-black p-20 relative bg-[url('https://example.com/background-image.jpg')] bg-no-repeat bg-bottom-left bg-[length:300px_200px] max-[1023px]:bg-none max-[1440px]:bg-none">
    {/* top content  */}
    <div className="w-[25%] max-sm:w-11/12 flex flex-col max-lg:items-center max-lg:text-center gap-5">
      <figure>
        <img src={hey} alt=" blog logo"className="bloggie" />
      </figure>
