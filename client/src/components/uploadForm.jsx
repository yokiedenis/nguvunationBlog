    // src/components/gallery/UploadForm.jsx
    import React, { useState, useRef } from 'react';
    import { toast } from 'react-toastify';

    const UploadForm = ({ eventId,onClose, onSuccess, token }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await fetch(`${process.env.REACT_APP_GALLERY_SERVICE_URL}/videos/upload`, {
            method: 'POST',
            headers: {
  ...
  <div className="mb-4 bg-blue-50 p-3 rounded-lg">
    ...
    <div className="flex items-center">
      ...
      <p className="font-semibold text-blue-600">
        {eventId} {/* Consider replacing with event name if available */}
      </p>
    </div>
  </div>
)}
